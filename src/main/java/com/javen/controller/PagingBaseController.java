...
public class PagingBaseController {  
    ...
    public String responseResult(Object obj){  
        ...
        if(obj != null){  
            logger.info("jilei responsResult 后端返回对象：{}", obj);  
            JsonConfig jsonConfig = new JsonConfig();   
            jsonConfig.registerJsonValueProcessor(Date.class, new JsonDateValueProcessor());  
            jsonObj = JSONObject.fromObject(obj, jsonConfig);  
            logger.info("jilei responsResult 后端返回数据：" + jsonObj);  
        ...
        logger.info("jilei responsResult 输出结果：{}", jsonObj.toString());  
    ...
    public String responseSuccess(Object obj){  
        JSONObject jsonObj = null;  
        if(obj != null){  
            logger.info("jilei responsSuccess 后端返回对象：{}", obj);  
            JsonConfig jsonConfig = new JsonConfig();   
            jsonConfig.registerJsonValueProcessor(Date.class, new JsonDateValueProcessor());  
            jsonObj = JSONObject.fromObject(obj, jsonConfig);  
            logger.info("jilei responsSuccess 后端返回数据：" + jsonObj);  
            jsonObj.element(HttpConstants.RESPONSE_RESULT_FLAG_ISERROR, false);  
            jsonObj.element(HttpConstants.SERVICE_RESPONSE_RESULT_MSG, "");  
        }  
        logger.info("jilei responsSuccess 输出结果：{}", jsonObj.toString());  
        return jsonObj.toString();  
    }  
    ...
    public String responseArraySuccess(Object obj){  
        ...
        if(obj != null){  
            logger.info("jilei responsArraySuccess 后端返回对象：{}", obj);  
            JsonConfig jsonConfig = new JsonConfig();  
            jsonConfig.registerJsonValueProcessor(Date.class, new JsonDateValueProcessor());  
            jsonObj = JSONArray.fromObject(obj, jsonConfig);  
            logger.info("jilei responsArraySuccess 后端返回数据：" + jsonObj);  
        }  
        logger.info("jilei responsArraySuccess 输出结果：{}", jsonObj.toString());  
        return jsonObj.toString();  
    }  
    ...
    public String responseSuccess(Object obj, String msg){  
        JSONObject jsonObj = null;  
        if(obj != null){  
            logger.info("jilei responsSuccess 2 prams 后端返回对象：{}", obj);  
            JsonConfig jsonConfig = new JsonConfig();   
            jsonConfig.registerJsonValueProcessor(Date.class, new JsonDateValueProcessor());  
            jsonObj = JSONObject.fromObject(obj, jsonConfig);  
            logger.info("jilei responsSuccess 2 prams 后端返回数据：" + jsonObj);  
            jsonObj.element(HttpConstants.RESPONSE_RESULT_FLAG_ISERROR, false);  
            jsonObj.element(HttpConstants.SERVICE_RESPONSE_RESULT_MSG, msg);  
        }  
        logger.info("jilei responsSuccess 2 prams 输出结果：{}", jsonObj.toString());  
        return jsonObj.toString();  
    }  
    ...
    public String responseFail(String errorMsg){  
        ...
        logger.info("jilei responsFail 输出结果：{}", jsonObj.toString());  
        return jsonObj.toString();  
    }  
